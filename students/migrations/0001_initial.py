    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('raports', models.TextField(max_length=256, verbose_name='\u0420\u0430\u043f\u043e\u0440\u0442\u0438 \u043d\u0430 \u0433\u0440\u0443\u043f\u0443', blank=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('middle_name', models.CharField(default=b'', max_length=256, verbose_name='\u041f\u043e \u0431\u0430\u0442\u044c\u043a\u043e\u0432\u0456')),
                ...
                ('notes', models.TextField(verbose_name='\u0414\u043e\u0434\u0430\u0442\u043a\u043e\u0432\u0456 \u043d\u043e\u0442\u0430\u0442\u0430\u0442\u043a\u0438 ', blank=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(verbose_name='ID', serialize=False, auto_created=True, primary_key=True)),
                ('exam_title', models.CharField(max_length=256, verbose_name='\u041d\u0430\u0437\u0432\u0430 \u0435\u043a\u0437\u0430\u043c\u0435\u043d\u0443 ')),
                ('teacher', models.CharField(max_length=256, verbose_name='\u0412\u0438\u043a\u043b\u0430\u0434\u0430\u0447')),
                ('date', models.DateField(null=True, verbose_name='\u0414\u0430\u0442\u0430 \u0435\u043a\u0437\u0430\u043c\u0435\u043d\u0443 ')),
                ('notes', models.TextField(verbose_name='\u041d\u043e\u0442\u0430\u0442\u043a\u0438', blank=True)),
                ('groupexams', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, verbose_name='\u0413\u0440\u0443\u043f\u0430', to='students.Group', null=True)),
            ],
            options={
